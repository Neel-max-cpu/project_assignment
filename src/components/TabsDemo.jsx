                    ...
                    <Card className="h-[300px] rounded-lg shadow-none border-none">                        
                        <CardContent className="h-full py-6 px-4">
                            ...
                            <div className="flex flex-col justify-between h-full">
                                <Button onClick={handleClick} className="w-full h-10 space-x-2 flex justify-center items-center border border-gray-300 shadow-none rounded-md">
                                    <img src={gitH} alt="GitHub" className="w-5 h-5" />
                                    <span className="text-base">Sign in with GitHub</span>
                                </Button>                               
                                <Button onClick={handleClick} className="w-full space-x-2 flex justify-center items-center border border-gray-300 shadow-none rounded-md">
